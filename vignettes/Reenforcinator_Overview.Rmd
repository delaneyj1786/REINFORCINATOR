...
sub3 <- read_csv("C:/Users/delan/Dropbox/My PC (LAPTOP-AEGRJVG9)/Desktop/Sage Analysis/jamedat3_sub2.csv")
```
...
```{r sub 2 plot 1}
require(tidyverse)
test_sub2_df<-recounter(sub2,BEH,"OA","A")$recounted_data_frame
